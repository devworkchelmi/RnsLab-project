...
class PagesControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Pages::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'page[title]' => 'Testing',
            'page[metaDescription]' => 'Testing',
            'page[metaKeywords]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'page[metaDescription]' => 'Something New',
            'page[metaKeywords]' => 'Something New',
        ]);
